...
import { trackAnthropicMessagesStreamEvent } from "@/lib/gateway/protocol-adapters/streaming/anthropic-events";
import type { ProtocolStreamAdapter } from "@/lib/gateway/protocol-adapters/streaming/types";

export { trackAnthropicMessagesStreamEvent } from "@/lib/gateway/protocol-adapters/streaming/anthropic-events";
...
export const anthropicMessagesStreamAdapter: ProtocolStreamAdapter = {
  ...
  encode: (events, options) => encodeAnthropicMessagesStream(events, options),
